...
def start():
    banner = pyfiglet.figlet_format("DIAMOND")
    print(Fore.RED)
    ...
    print(
        ...
        f"Создано ANTICHRIST Для Кривошеиной Ники \nНомер телефона: {phone}\nКол-во кругов: {count} "
        + Style.RESET_ALL)
    print(Fore.GREEN + '------------------------------------' +
          Style.RESET_ALL)
    global iteration
...
def menu():
    ...
    print(Fore.GREEN + '-------------------------------')
    print(Fore.GREEN +
          '''Создано ANTICHRIST для Кривошеиной Ники\nVersion 0.1.0\n anti_hrist_''')
    print(Fore.GREEN + '-------------------------------')
    global phone
    ...
    check_number()
    global count
    count = input(Fore.RED + 'Кол-во кругов: ' + Style.RESET_ALL)
    print('------------------------------------')
    count = int(count)
    os.system("clear")
    generate_info()
